 ...
 * trailing '\n' or '\r')
 */
bool read_line_into_string(uint8_t itf,
                           std::string& line_buf,
                           bool echo_mid_line = true) {
...
struct config_console_value {
 ...
 public:
  config_console_value(const std::string name, float* value_float)
      : name(name), value_float(value_float) {}
  config_console_value(const std::string name, uint64_t* value_uint64_t)
      : name(name), value_uint64_t(value_uint64_t) {}
  config_console_value(const std::string name, int* value_int)
      : name(name), value_int(value_int) {}
  config_console_value(const std::string name, bool* value_bool)
      : name(name), value_bool(value_bool) {}
